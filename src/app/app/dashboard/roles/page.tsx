				...
				<div>
					...
					<div className="grid sm:grid-cols-3 lg:grid-cols-4 gap-x-0 gap-y-10">
						{roles.map(role => (
							<div
								key={role.id}
								className="relative mx-2 mb-3 p-3 border rounded-md hover:shadow-lg cursor-pointer">
								...
								<div className="absolute inset-x-0 bottom-1 mt-10 flex justify-between items-center">
